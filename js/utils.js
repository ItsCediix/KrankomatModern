...
Krankomat.Utils = {
    ...
    showToast: (message, type = 'error') => {
        ...
        toast.className = `p-3 rounded-lg shadow-lg text-sm text-white animate-scale-in flex items-center gap-2 ${type === 'error' ? 'bg-red-500' : 'bg-green-500'}`;
        toast.innerHTML = `
    ...
    Icons: {
        ...
        doubleCheck: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" class="h-6 w-6"><path d="M251.6 230.1c-12.5-12.5-32.8-12.5-45.3 0L160 276.5l-46.4-46.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l69.1 69.1c12.5 12.5 32.8 12.5 45.3 0l69.1-69.1c12.5-12.5 12.5-32.8 0-45.3zM438.6 105.4c-12.5-12.5-32.8-12.5-45.3 0L160 338.7l-93.3-93.3c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l116 116c12.5 12.5 32.8 12.5 45.3 0l256-256c12.5-12.5 12.5-32.8 0-45.3z"/></svg>',
